...
int main() {
    ...
    // test convolution
    std::cout<<"test_conv_giris"<<std::endl;
    std::cout<<"**********************************"<<std::endl;
    test_conv(score, total_number);
    std::cout<<"test_conv_cikis"<<std::endl;

    std::cout<<"test_sharp_giris"<<std::endl;
    std::cout<<"**********************************"<<std::endl;
    // test sharpening
    test_sharpening(score, total_number);
    std::cout<<"test_sharp_cikis"<<std::endl;


    std::cout<<"test_edge_giris"<<std::endl;
    std::cout<<"**********************************"<<std::endl;
    // test edge detection
    test_edge_detection(score, total_number);
    std::cout<<"test_edge_cikis"<<std::endl;


    std::cout<<"test_enc_giris"<<std::endl;
    std::cout<<"**********************************"<<std::endl;
    // test encode message
    test_encode_mssg(score, total_number);
    std::cout<<"test_enc_cikis"<<std::endl;


    std::cout<<"test_dec_giris"<<std::endl;
    std::cout<<"**********************************"<<std::endl;
    // test decode message
    test_decode_msg(score, total_number);
    std::cout<<"test_dec_cik"<<std::endl;


    std::cout<<"test_proce_encode_giris"<<std::endl;
    std::cout<<"**********************************"<<std::endl;
    // test image processor's encoder   
    img_processor_encode(score, total_number);
    std::cout<<"test_proce_encode_cik"<<std::endl;

    std::cout<<"test_proce_dec_giris"<<std::endl;
    std::cout<<"**********************************"<<std::endl;
    // test image processor's decoder
    img_processor_decode(score, total_number);
    std::cout<<"test_proce_dec_cik"<<std::endl;
